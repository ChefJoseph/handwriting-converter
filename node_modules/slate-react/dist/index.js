...
function forceSwiftKeyUpdate(editor) {
  ...
  (_div$parentElement = div.parentElement) === null || _div$parentElement === void 0 ? void 0 : _div$parentElement.removeChild(div);
...
function createAndroidInputManager(_ref) {
  ...
  var performAction = function performAction() {
    ...
    var targetRange = slate.Editor.range(editor, target);

    if (!editor.selection || !slate.Range.equals(editor.selection, targetRange)) {
  ...
  var flush = function flush() {
    ...
    if (selection && (!editor.selection || !slate.Range.equals(selection, editor.selection))) {
  ...
  var scheduleAction = function scheduleAction(at, run) {
    EDITOR_TO_PENDING_SELECTION["delete"](editor);
    scheduleOnDOMSelectionChange.cancel();
    onDOMSelectionChange.cancel();
  ...
  var handleDOMBeforeInput = function handleDOMBeforeInput(event) {
    ...
    targetRange = (_targetRange = targetRange) !== null && _targetRange !== void 0 ? _targetRange : editor.selection;
    ...
    if (slate.Range.isExpanded(targetRange) && type.startsWith('delete')) {
      ...
      return scheduleAction(targetRange, function () {
    ...
    switch (type) {
      ...
      case 'deleteContentForward':
        {
          var _targetRange2 = targetRange,
              anchor = _targetRange2.anchor;
      ...
      case 'deleteContentBackward':
        {
          ...
          var _targetRange3 = targetRange,
              _anchor = _targetRange3.anchor; // If we have a mismatch between the native and slate selection being collapsed
      ...
      case 'insertText':
        {
          ...
          if (typeof data === 'string' && data.includes('\n')) {
            return scheduleAction(slate.Range.end(targetRange), function () {
              return slate.Editor.insertSoftBreak(editor);
            });
          }
  ...
  var handleUserSelect = function handleUserSelect(range) {
    ...
    var pathChanged = range && (!editor.selection || !slate.Path.equals(editor.selection.anchor.path, range === null || range === void 0 ? void 0 : range.anchor.path));
    ...
    onBeforeInput: React.useCallback(function (event) {
      ...
      if (!HAS_BEFORE_INPUT_SUPPORT && !readOnly && !isEventHandled(event, attributes.onBeforeInput) && hasEditableTarget(editor, event.target)) {
        ...
        if (!ReactEditor.isComposing(editor)) {
          ...
          slate.Editor.insertText(editor, _text);
        }
      }
    }, [readOnly]),
...
var withReact = function withReact(editor) {
  ...
  e.apply = function (op) {
    ...
    if (pendingAction) {
      var at = slate.Point.isPoint(pendingAction === null || pendingAction === void 0 ? void 0 : pendingAction.at) ? transformPendingPoint(editor, pendingAction.at, op) : transformPendingRange(editor, pendingAction.at, op);
      EDITOR_TO_PENDING_ACTION.set(editor, at ? _objectSpread(_objectSpread({}, pendingAction), {}, {
        at: at
      }) : null);
    }
